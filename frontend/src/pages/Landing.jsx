...
export default function Landing() {
  ...
  useEffect(() => {
    // Acorda o banco/servidor em background enquanto o usuário navega
    ...
    <div style={{ backgroundColor: "var(--bg-main)", minHeight: "100vh", color: "var(--text-main)", overflowX: "hidden" }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
          <Link to="/login" style={{ color: "var(--text-muted)", textDecoration: "none", fontSize: "14px", fontWeight: "500", transition: "color 0.2s" }}>
            Entrar
          </Link>
      ...
      <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 32px 120px 32px", textAlign: "center", position: "relative" }}>
        ...
        <h1 style={{ 
          ...
          O setup inicial do seu projeto pronto em segundos.
        </h1>
        ...
        <p style={{ 
          ...
          Escolha sua stack de preferência, customize o nome do build e faça o download de uma estrutura limpa, profissional e pronta para produção.
        </p>
        ...
        <div style={{
          ...
          {/* Barra superior estilizada de app */}
          ...
          {/* Corpo do Preview visual do App */}
          <div style={{ padding: "30px", backgroundColor: "#0b0b0d", borderRadius: "0 0 8px 8px", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "16px", textAlign: "left" }}>
            ...
            <div style={{ padding: "16px", border: "1px solid var(--border-glow)", borderRadius: "8px", backgroundColor: "var(--bg-card)", opacity: 0.5 }}>
            ...
            <div style={{ padding: "16px", border: "1px solid var(--border-glow)", borderRadius: "8px", backgroundColor: "var(--bg-card)", opacity: 0.5 }}>
              <div style={{ fontSize: "11px", fontWeight: "bold", color: "var(--text-muted)", marginBottom: "4px" }}>BOT</div>
